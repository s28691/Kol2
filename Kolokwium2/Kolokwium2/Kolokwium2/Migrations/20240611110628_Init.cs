        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AckquiredAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 120, "Janusz", "Michlosw", 150 },
                    { 2, 90, "Michal", "januszewski", 120 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "CharacterId", "TitleId", "AckquiredAt" },
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 5, 31, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 2, 2, new DateTime(2025, 1, 31, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });
